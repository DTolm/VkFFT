...
#if(VKFFT_BACKEND_IS_VULKAN) //Vulkan API
...
#elif(VKFFT_BACKEND_IS_CUDA) //CUDA API
...
#elif(VKFFT_BACKEND_IS_HIP) //HIP API
...
#elif(VKFFT_BACKEND_IS_OPENCL) //OpenCL API
...
#elif(VKFFT_BACKEND_IS_LEVEL_ZERO) //Level Zero API
...
#elif(VKFFT_BACKEND_IS_METAL) //Metal API
MTL::Device* device;
...
#if(VKFFT_BACKEND_IS_VULKAN) //Vulkan API needs bufferSize at initialization	
