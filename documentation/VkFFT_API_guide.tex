...
#if(VKFFT_BACKEND_VULKAN) //Vulkan API
...
#elif(VKFFT_BACKEND_CUDA) //CUDA API
...
#elif(VKFFT_BACKEND_HIP) //HIP API
...
#elif(VKFFT_BACKEND_OPENCL) //OpenCL API
...
#elif(VKFFT_BACKEND_LEVEL_ZERO) //Level Zero API
...
#elif(VKFFT_BACKEND_METAL) //Metal API
MTL::Device* device;
...
#if(VKFFT_BACKEND_VULKAN) //Vulkan API needs bufferSize at initialization	
