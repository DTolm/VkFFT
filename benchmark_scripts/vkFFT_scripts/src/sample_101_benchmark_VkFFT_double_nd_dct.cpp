...
VkFFTResult sample_101_benchmark_VkFFT_double_nd_dct(VkGPU* vkGPU, uint64_t file_output, FILE* output, uint64_t isCompilerInitialized, uint64_t dct_type)
{
	...
	printf("1%" PRIu64 "1 - VkFFT FFT + iFFT R2R DCT-%" PRIu64 " multidimensional benchmark in double precision\n", dct_type, dct_type);

	const int num_benchmark_samples = 32;
	const int num_runs = 3;
	uint64_t benchmark_dimensions[num_benchmark_samples][4] = { {1024, 512, 1, 2},  
	{720, 480, 1, 2}, {300, 300, 1, 2}, {300, 300, 300, 3},{500, 500, 1, 2}, {500, 500, 100, 3},{700, 700, 100, 3},
	...
	{(uint64_t)pow(2,9), (uint64_t)pow(2,8), 1, 2},{(uint64_t)pow(2,9), (uint64_t)pow(2,9), 1, 2},	{(uint64_t)pow(2,10), (uint64_t)pow(2,9), 1, 2},	{(uint64_t)pow(2,11), (uint64_t)pow(2,9), 1, 2},{(uint64_t)pow(2,12), (uint64_t)pow(2,9), 1, 2},
	...
	{(uint64_t)pow(2,8), (uint64_t)pow(2,8), (uint64_t)pow(2,8), 3},{(uint64_t)pow(2,9), (uint64_t)pow(2,8), (uint64_t)pow(2,8), 3}, {(uint64_t)pow(2,9), (uint64_t)pow(2,9), (uint64_t)pow(2,8), 3}
	};
